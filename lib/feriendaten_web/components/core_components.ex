defmodule FeriendatenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FeriendatenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FeriendatenWeb.Gettext, "errors", msg, opts)
    end
  end
